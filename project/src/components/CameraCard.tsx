...
export const CameraCard: React.FC<CameraCardProps> = ({ camera, isPremium = false }) => {
  ...
  return (
    <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-lg p-4 hover:bg-gray-800/50 transition-all duration-200">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className={`text-sm font-medium ${getStatusColor(camera.status)}`}>
